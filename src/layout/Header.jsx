...
function Header() {
  ...
  return (
    <header className="header relative flex flex-col justify-start px-6 py-10">
      <nav id="main-nav">
        <div className="flex-1 flex justify-between items-center">
          ...
          <ul className={`hidden md:flex justify-between items-center gap-12`}>
            ...
            <li className="font-fraunces uppercase ">
              <a
                href="#"
                className="inline-block px-6 py-4 rounded-full text-veryDarkDesaturatedBlue bg-white"
              >
                Contact
              </a>
            </li>
          ...
          <button className="sm:hidden" onClick={() => toggle((prev) => !prev)}>
        ...
        >
          ...
          <ul className={`z-10 flex flex-col gap-8 text-center bg-white py-10`}>
            {constants.menuEntries.map((entry, index) => {
              return (
                <li
